...
import { Connection, PublicKey, RpcResponseAndContext, SendOptions, SignatureResult, Signer, Transaction, TransactionError, TransactionResponse, TransactionSignature } from '@solana/web3.js';
import { Assert, AssertOpts } from '../asserts/asserts';
export type { MaybeErrorWithCode } from '@metaplex-foundation/cusper';
/** @private */
export declare type ErrorFromProgramLogs = (logs: string[]) => MaybeErrorWithCode;
/** @private */
...
export declare type ConfirmedTransactionAsserts = {
    assertError<Err extends Function>(t: Assert, errOrRx: Err | RegExp, msgRx?: RegExp): void;
 ...
 * @category transactions
 */
export declare class ConfirmedTransactionDetails {
     ...
     */
    assertLogs(t: Assert, msgRxs: RegExp[], opts: AssertOpts): Promise<void>;
}
/**
...
export declare type TransactionHandler = {
     ...
     */
    sendAndConfirmTransaction(transaction: Transaction, signers: Array<Signer>, optionsOrLabel?: SendOptions | string, label?: string): Promise<ConfirmedTransactionDetails>;
};
